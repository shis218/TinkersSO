...
public class PartServer implements Part {
int count=0;
...
private int[] codigoDasPeçasUsadas;  //Caso a parte seja criada, então deve colocar quais 'codigoDestaPeca'/'codigoDesteBloco'/'CodigoDesteItem' foram usadas pra completar a recipe
	...
	public static void main(String[] args) {
		try {
	       ...
	       matI[1]=50;
	       matI[2]=50;
	       PartServer server = new PartServer(1,"cabeça",matS,matI,null);
	...
	public PartServer(int ingameID, String nome, String[] recipeString, int[] recipeIDs,Materiais material) throws RemoteException {
		super();
	...
	public Part clonaRecipe() throws RemoteException {
		Part ret=new PartServer(this.ingameID,this.nome,this.recipeString,this.recipeIDs,this.materialTrait);
		return ret;
	}
